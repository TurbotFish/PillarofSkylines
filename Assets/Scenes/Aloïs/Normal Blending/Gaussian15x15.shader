Shader "Alo/Blur/GaussianBlur15x15"
{
	Properties
	{
	...
	CGINCLUDE
		...
		half4 SampleWithDepthCheck(float2 uv, float4 offset12, float4 offset34, float4 offset56) {
			...
			half3 s = 0.075 * lerp(_col1, _color.rgb, _diff1) + 0.13 * lerp(_col2, _color.rgb, _diff2) + 0.19 * lerp(_col3, _color.rgb, _diff3) + 0.21 * _color.rgb + 0.19 * lerp(_col4, _color.rgb, _diff4) +
						0.13 * lerp(_col5, _color.rgb, _diff5) + 0.075 * lerp(_col6, _color.rgb, _diff6);
