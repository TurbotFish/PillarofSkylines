...
Shader "Bobo/test_terrain"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 hsvTorgb62 = HSVToRGB( float3((0.0 + (v.color.r - 0.5) * (1.0 - 0.0) / (1.0 - 0.5)),0.9,1.0) );
			float3 lerpResult66 = lerp( ase_vertexNormal , (( v.color.r < 0.5 ) ? -hsvTorgb62 :  hsvTorgb62 ) , v.color.b);
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb62 = HSVToRGB( float3((0.0 + (i.vertexColor.r - 0.5) * (1.0 - 0.0) / (1.0 - 0.5)),0.9,1.0) );
			float3 lerpResult66 = lerp( ase_vertexNormal , (( i.vertexColor.r < 0.5 ) ? -hsvTorgb62 :  hsvTorgb62 ) , i.vertexColor.b);
...
/*ASEBEGIN
Version=13201
1927;29;1906;1004;2995.711;758.6471;2.452364;True;True
Node;AmplifyShaderEditor.VertexColorNode;25;-1756.88,808.5049;Float;False;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;134;-1700.726,1093.85;Float;False;Constant;_Float8;Float 8;8;0;1;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;129;-1706.726,1000.849;Float;False;Constant;_Float5;Float 5;8;0;0.5;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;131;-1704.726,1192.85;Float;False;Constant;_Float7;Float 7;8;0;0;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.TFHCRemap;128;-1430.526,977.045;Float;False;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;3;FLOAT;0.0;False;4;FLOAT;1.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1420.794,741.9042;Float;False;Constant;_Float4;Float 4;8;0;0.9;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;64;-1413.84,818.187;Float;False;Constant;_Float3;Float 3;4;0;1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.NegateNode;136;-901.6293,1047.762;Float;False;1;0;FLOAT3;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.TFHCCompareLower;137;-717.9435,976.8034;Float;False;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT3;0.0;False;3;FLOAT3;0,0,0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.NormalVertexDataNode;86;-1602.763,499.6758;Float;False;0;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.LerpOp;66;-528.5607,899.7818;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.ToggleSwitchNode;87;271.7764,116.3947;Float;False;Property;_show_normal;show_normal;7;0;0;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0;False;1;FLOAT3
...
ASEEND*/
//CHKSM=03BD145BF232F12A5360DC559A9BE32E207E840E