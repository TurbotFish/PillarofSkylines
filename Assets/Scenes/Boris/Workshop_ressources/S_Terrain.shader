...
Shader "Bobo/test_terrain"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 lerpResult66 = lerp( ase_vertexNormal , hsvTorgb62 , v.color.b);
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb62 = HSVToRGB( float3(i.vertexColor.r,1.0,1.0) );
			float3 lerpResult66 = lerp( ase_vertexNormal , hsvTorgb62 , i.vertexColor.b);
...
/*ASEBEGIN
Version=13201
1927;29;1906;1004;2177.546;-24.57559;1.358438;True;True
...
Node;AmplifyShaderEditor.VertexColorNode;25;-1588.88,809.5049;Float;False;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RGBToHSVNode;89;-1384.53,398.6013;Float;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.WorldNormalVector;4;-1608.653,658.901;Float;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=934708896C841A692FDCBFA3D62DAF0CE8811A33