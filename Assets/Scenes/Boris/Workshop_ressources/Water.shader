...
Shader "Bobo/Water2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult384 = lerp( ( Foam312 + ( ( Albedo296 * _Emission_power ) + ( lerpResult287 * _Show_distance ) ) ) , ( tex2D( _Texture0, temp_cast_11 ) * 1.0 ) , temp_output_410_0);
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;-54.2411;902.5701;1.6;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;412;1913.193,-437.4328;Float;True;Property;_Texture0;Texture 0;24;0;None;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.LerpOp;460;1646.241,254.2299;Float;False;3;0;COLOR;0.0,0,0,0;False;1;COLOR;0.0;False;2;FLOAT;0.0;False;1;COLOR
...
ASEEND*/
//CHKSM=D0887B63A1F3404B0D03D8EE663585E7E7F6E929