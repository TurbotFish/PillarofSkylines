...
Shader "Bobo/Water2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_10 = (temp_output_174_0).xx;
			float2 componentMask183 = ( componentMask258 - temp_cast_10 ).xy;
			...
			float2 temp_cast_15 = (saturate( ( ( i.eyeDepth + -temp_output_417_0 ) / ( _Float26 - temp_output_417_0 ) ) )).xx;
			float4 lerpResult384 = lerp( ( Foam312 + ( ( Albedo296 * _Emission_power ) + ( Projection_color256 + ( lerpResult287 * _Show_distance ) ) ) ) , ( tex2D( _Texture0, temp_cast_15 ) * 1.0 ) , temp_output_410_0);
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;636.7543;1715.711;2.8;False;True
...
Node;AmplifyShaderEditor.GetLocalVarNode;314;1932.248,-46.44593;Float;False;312;0;1;COLOR
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;425;2549.593,-413.1903;Float;False;2;2;0;COLOR;0.0;False;1;FLOAT;0.0,0,0,0;False;1;COLOR
...
ASEEND*/
//CHKSM=98E4202C7889C439C923FD81A7008BC0003C9172