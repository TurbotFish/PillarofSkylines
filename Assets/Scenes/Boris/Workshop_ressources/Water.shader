...
Shader "Bobo/Water2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult443 = lerp( lerp(Albedo296,_Gradient_color,_ToggleSwitch0) , Albedo296 , saturate( ( ( ase_worldPos.y + 90.0 ) * 0.05 ) ));
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;-441.8339;1032.602;1.441674;True;True
...
Node;AmplifyShaderEditor.ToggleSwitchNode;446;1691.644,401.9216;Float;False;Property;_ToggleSwitch0;Toggle Switch0;32;0;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0.0,0,0,0;False;1;COLOR
...
ASEEND*/
//CHKSM=B38251770E41F5CD0F2C6FF9A1172D95F0B2CDCF