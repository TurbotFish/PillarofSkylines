...
public class ThirdPersonControllerAI : MonoBehaviour {
	...
	[Header("AI")]
	public Vector2 AImvt;
	public bool AIrunning;
	public bool AIjumping;
    ...
    float currentForce {
        get {
            ...
            if (controller.isGrounded)
				lastForce = AIrunning ? runForce : walkForce;
            return lastForce;
        }
    }
    ...
    void Update() {
		...
		xForce = AImvt.x * currentForce;
		zForce = AImvt.y * currentForce;
