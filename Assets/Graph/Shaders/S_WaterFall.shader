...
////// Emissive:
                float3 emissive = (_Color_copy.rgb*0.7);
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,saturate(lerp(node_5755,lerp(_Opacity,lerp(_Opacity,node_5755,pow((_Cloud_var.r*node_600),node_600)),_Up_mask_var.r),_Upper_mask_var.r)));
...
/// Final Color:
                ...
                float4 _Up_mask_var = tex2D(_Up_mask,TRANSFORM_TEX(i.uv0, _Up_mask));
                float4 _Upper_mask_var = tex2D(_Upper_mask,TRANSFORM_TEX(i.uv0, _Upper_mask));
                fixed4 finalRGBA = fixed4(finalColor * saturate(lerp(node_5755,lerp(_Opacity,lerp(_Opacity,node_5755,pow((_Cloud_var.r*node_600),node_600)),_Up_mask_var.r),_Upper_mask_var.r)),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
