...
Shader "Bobo/Tomb_dissolve"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_152_0 = ( (-0.6 + (( 1.0 - _Dissolve ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + triplanar155.x );
			float clampResult166 = clamp( (-4.0 + (temp_output_152_0 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
			float temp_output_167_0 = ( 1.0 - clampResult166 );
			float4 appendResult173 = (float4(temp_output_167_0 , 0.0 , 0.0 , 0.0));
			o.Emission = ( temp_output_167_0 * ( tex2D( _TextureSample2, appendResult173.xy ) * 5.0 ) ).xyz;
			o.Metallic = 0.0;
			...
			o.Alpha = 1;
			clip( temp_output_152_0 - _Cutoff );
		}
...
/*ASEBEGIN
Version=13201
-1902;30;1906;1004;802.4666;-1223.303;1;True;True
...
Node;AmplifyShaderEditor.DynamicAppendNode;173;239.7999,1916.065;Float;False;FLOAT4;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.RangedFloatNode;172;553.6929,1988.049;Float;False;Constant;_Float14;Float 14;18;0;5;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;758.0623,1762.926;Float;False;2;2;0;FLOAT4;0.0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.LerpOp;64;-2202.644,2467.847;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.0,0,0,0;False;1;FLOAT
Node;AmplifyShaderEditor.LerpOp;59;-2200.174,2053.168;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.0,0,0,0;False;1;FLOAT
...
Node;AmplifyShaderEditor.LerpOp;61;-2187.519,2241.581;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.0,0,0;False;1;FLOAT
...
Node;AmplifyShaderEditor.AppendNode;168;223.5639,1766.222;Float;False;FLOAT2;0;0;0;0;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT2
...
ASEEND*/
//CHKSM=4ED755F390C0AFA78C1651C688F428B379312621