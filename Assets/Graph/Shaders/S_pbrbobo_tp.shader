...
Shader "Bobo/PBR_tp"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 worldTriplanarNormal137 = TriplanarNormal( _N2, _N2, _N2, ase_worldPos, ase_worldNormal, 1.0, _Tiling_2, 0 );
			float3 tanTriplanarNormal137 = mul( ase_worldToTangent, worldTriplanarNormal137 );
			float3 worldTriplanarNormal133 = TriplanarNormal( _N1, _N1, _N1, ase_worldPos, ase_worldNormal, 1.0, _Tiling_1, 0 );
			...
			float3 lerpResult61 = lerp( tanTriplanarNormal137 , tanTriplanarNormal133 , tex2DNode47.r);
			float3 worldTriplanarNormal140 = TriplanarNormal( _N3, _N3, _N3, ase_worldPos, ase_worldNormal, 1.0, _Tiling_3, 0 );
			float3 tanTriplanarNormal140 = mul( ase_worldToTangent, worldTriplanarNormal140 );
			float3 lerpResult62 = lerp( lerpResult61 , tanTriplanarNormal140 , tex2DNode47.g);
			float3 Normal63 = lerpResult62;
			float2 uv_Normal = i.uv_texcoord * _Normal_ST.xy + _Normal_ST.zw;
			o.Normal = BlendNormals( Normal63 , UnpackScaleNormal( tex2D( _Normal, uv_Normal ) ,1.0 ) );
			float4 triplanar135 = TriplanarSampling( _C2, _C2, _C2, ase_worldPos, ase_worldNormal, 1.0, _Tiling_2, 0 );
			float4 triplanar131 = TriplanarSampling( _C1, _C1, _C1, ase_worldPos, ase_worldNormal, 1.0, _Tiling_1, 0 );
			float4 lerpResult59 = lerp( triplanar135 , triplanar131 , tex2DNode47.r);
			float4 triplanar138 = TriplanarSampling( _C3, _C3, _C3, ase_worldPos, ase_worldNormal, 1.0, _Tiling_3, 0 );
			float4 lerpResult60 = lerp( lerpResult59 , triplanar138 , tex2DNode47.g);
			...
			o.Metallic = 0.0;
			float4 triplanar136 = TriplanarSampling( _RME2, _RME2, _RME2, ase_worldPos, ase_worldNormal, 1.0, _Tiling_2, 0 );
			float4 triplanar134 = TriplanarSampling( _RME1, _RME1, _RME1, ase_worldPos, ase_worldNormal, 1.0, _Tiling_1, 0 );
			float4 lerpResult64 = lerp( triplanar136 , triplanar134 , tex2DNode47.r);
			float4 triplanar139 = TriplanarSampling( _RME3, _RME3, _RME3, ase_worldPos, ase_worldNormal, 1.0, _Tiling_3, 0 );
			float4 lerpResult65 = lerp( lerpResult64 , triplanar139 , tex2DNode47.g);
...
/*ASEBEGIN
Version=13201
7;29;1906;1004;2908.884;-328.0378;1.289045;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;132;-3944.316,1135.939;Float;False;Constant;_Float10;Float 10;14;0;1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;47;-2787.344,2778.761;Float;True;Property;_T_Groundtile1_MaskMat;T_Groundtile1_MaskMat;1;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;576.0913,23.72815;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Bobo/PBR_tp;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=F6F2E55E6132DAC1CAA29A13B7225A4DFBD7B128