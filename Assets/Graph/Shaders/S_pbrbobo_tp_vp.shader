...
Shader "Bobo/PBR_tp_vp"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult61 = lerp( tanTriplanarNormal137 , tanTriplanarNormal133 , i.vertexColor.r);
			...
			float3 lerpResult62 = lerp( lerpResult61 , tanTriplanarNormal140 , i.vertexColor.g);
			...
			float4 lerpResult59 = lerp( triplanar135 , triplanar131 , i.vertexColor.r);
			float4 triplanar138 = TriplanarSampling( _C3, _C3, _C3, ase_worldPos, ase_worldNormal, 2.0, _Tiling_3, 0 );
			float4 lerpResult60 = lerp( lerpResult59 , triplanar138 , i.vertexColor.g);
			...
			float4 lerpResult64 = lerp( triplanar136 , triplanar134 , i.vertexColor.r);
			float4 triplanar139 = TriplanarSampling( _RME3, _RME3, _RME3, ase_worldPos, ase_worldNormal, 2.0, _Tiling_3, 0 );
			float4 lerpResult65 = lerp( lerpResult64 , triplanar139 , i.vertexColor.g);
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;4217.267;-1364.64;1.515962;True;True
...
ASEEND*/
//CHKSM=875F88BA46D1CAF5A3EF8769C2FB07A09EC6390F