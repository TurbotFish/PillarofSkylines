    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_5089 = ((float2((i.uv0.r*(objScale.r/objScale.g)),i.uv0.g)*objScale.g)*_Tiling);
...
////// Emissive:
                float node_821 = 0.0;
                float3 emissive = (lerp(_Shadow_color.rgb,float3(node_821,node_821,node_821),pow(0.0,1.0))+saturate(lerp(float3(node_821,node_821,node_821),_Fresnel_color.rgb,(pow(1.0-max(0,dot(normalDirection, viewDirection)),_Fresnel)*0.2))));
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_821 = 0.0;
                o.Emission = (lerp(_Shadow_color.rgb,float3(node_821,node_821,node_821),pow(0.0,1.0))+saturate(lerp(float3(node_821,node_821,node_821),_Fresnel_color.rgb,(pow(1.0-max(0,dot(normalDirection, viewDirection)),_Fresnel)*0.2))));
