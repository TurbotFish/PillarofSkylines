...
Shader "Bobo/Gravifloor"
{
	Properties
	{
		...
		_CrystalNormal("CrystalNormal", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_124_0 = saturate( lerpResult54 );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldTriplanarNormal105 = TriplanarNormal( _CrystalNormal, _CrystalNormal, _CrystalNormal, ase_worldPos, ase_worldNormal, 3.0, 0.05, 0 );
			float3 tanTriplanarNormal105 = mul( ase_worldToTangent, worldTriplanarNormal105 );
			float3 appendResult122 = (float3(temp_output_124_0 , temp_output_124_0 , tanTriplanarNormal105.z));
			...
			float3 lerpResult67 = lerp( tanTriplanarNormal60 , tanTriplanarNormal105 , 0.5);
			o.Normal = BlendNormals( appendResult122 , BlendNormals( tanTriplanarNormal105 , lerpResult67 ) );
			...
			float4 lerpResult97 = lerp( ( _Crystal_color * 1.3 ) , temp_cast_1 , pow( clampResult10_g3 , 0.3 ));
			float4 temp_cast_2 = (0.0).xxxx;
			float4 lerpResult103 = lerp( lerpResult97 , temp_cast_2 , smoothstepResult43);
			float3 ase_vertexNormal = mul( unity_WorldToObject, float4( ase_worldNormal, 0 ) );
			float3 temp_cast_3 = (3.0).xxx;
			float4 triplanar155 = TriplanarSampling( _Latexturequibouge, _Latexturequibouge, _Latexturequibouge, ase_worldPos, ase_worldNormal, 3.0, 0.02, 0 );
			float2 appendResult161 = (float2(triplanar155.x , triplanar155.y));
			float2 temp_output_157_0 = ( appendResult161 * 0.1 );
			float mulTime149 = _Time.y * 0.1;
			...
			float3 weightedBlendVar133 = pow( abs( ase_vertexNormal ) , temp_cast_3 );
			...
			float4 temp_cast_4 = (3.0).xxxx;
			float4 temp_output_163_0 = pow( weightedAvg133 , temp_cast_4 );
			float4 lerpResult162 = lerp( lerpResult103 , _Crystal_color , ( temp_output_163_0 * 0.5 ));
			o.Emission = lerpResult162.rgb;
			float2 uv_TextureSample0 = i.uv_texcoord * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
			float4 tex2DNode114 = tex2D( _TextureSample0, uv_TextureSample0 );
			float lerpResult120 = lerp( 0.0 , tex2DNode114.r , smoothstepResult43);
			float4 temp_output_175_0 = saturate( temp_output_163_0 );
			float lerpResult173 = lerp( lerpResult120 , tex2DNode114.r , temp_output_175_0.r);
			o.Metallic = lerpResult173;
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;8126.407;4354.363;6.849604;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;139;-750.6965,-1681.159;Float;True;Property;_Latexturequibouge;Latexturequibouge;7;0;None;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-1154.053,-952.731;Float;False;Constant;_Float22;Float 22;8;0;0.1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;-1432.015,-942.9782;Float;False;2;2;0;FLOAT2;0.0;False;1;FLOAT;0.0;False;1;FLOAT2
...
Node;AmplifyShaderEditor.AbsOpNode;135;-517.4932,-1857.275;Float;False;1;0;FLOAT3;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.CommentaryNode;95;-528.7885,733.4227;Float;False;1164.812;555.8927;Normall;7;115;67;60;68;105;61;122;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.PowerNode;140;-243.7712,-1854.224;Float;False;2;0;FLOAT3;0.0;False;1;FLOAT;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.WeightedBlendNode;133;-7.190157,-1457.233;Float;False;5;0;FLOAT3;0.0;False;1;COLOR;0.0;False;2;COLOR;0.0,0,0,0;False;3;COLOR;0.0,0,0,0;False;4;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.ColorNode;119;-1403.181,-352.3546;Float;False;Property;_Crystal_color;Crystal_color;5;0;0.0660143,0.08088237,0.07764099,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.TriplanarNode;60;-309.6889,953.4774;Float;True;Spherical;World;True;Flake;_Flake;white;3;None;Mid Texture 0;_MidTexture0;white;4;None;Bot Texture 0;_BotTexture0;white;5;None;Triplanar Sampler;5;0;SAMPLER2D;;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;FLOAT;1.0;False;4;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.PowerNode;163;205.2424,-1451.333;Float;False;2;0;COLOR;0.0;False;1;FLOAT;0.0;False;1;COLOR
Node;AmplifyShaderEditor.TriplanarNode;105;-479.033,768.4252;Float;True;Spherical;World;True;CrystalNormal;_CrystalNormal;white;2;None;Mid Texture 1;_MidTexture1;white;4;None;Bot Texture 1;_BotTexture1;white;5;None;Triplanar Sampler;5;0;SAMPLER2D;;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;114;131.4739,325.2461;Float;True;Property;_TextureSample0;Texture Sample 0;6;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;165;373.115,-1447.148;Float;False;2;2;0;COLOR;0.0;False;1;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.SaturateNode;124;154.342,1491.231;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;121;264.9727,535.7709;Float;False;Constant;_Float3;Float 3;7;0;0;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.RelayNode;167;371.886,-919.3787;Float;False;1;0;COLOR;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.DynamicAppendNode;122;325.3549,957.4586;Float;False;FLOAT3;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.ColorNode;108;-1415.495,75.27348;Float;False;Property;_Color;Color;4;0;0.0660143,0.08088237,0.07764099,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SaturateNode;175;365.5485,-1000.641;Float;False;1;0;COLOR;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.LerpOp;162;545.9419,-100.6773;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.BlendNormalsNode;123;501.2437,1115.473;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.LerpOp;172;657.6741,102.5109;Float;False;3;0;FLOAT;0,0,0,0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1136.836,-62.31799;Float;False;True;6;Float;ASEMaterialInspector;0;0;Standard;Bobo/Gravifloor;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;1;5;5;10;True;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;3;173;0
WireConnection;0;4;172;0
ASEEND*/
//CHKSM=B90CB395C2B19519EFE3A3762B6A1901D1573596