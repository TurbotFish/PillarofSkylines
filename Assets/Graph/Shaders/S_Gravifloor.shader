...
Shader "Bobo/Gravifloor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 appendResult122 = (float3(temp_output_124_0 , temp_output_124_0 , 1.0));
			...
			float3 temp_output_123_0 = BlendNormals( appendResult122 , BlendNormals( tex2DNode179 , lerpResult67 ) );
			...
			float3 lerpResult177 = lerp( temp_output_123_0 , ( 1.0 - temp_output_123_0 ) , temp_output_175_0.r);
			o.Normal = lerpResult177;
			float2 uv_TextureSample4 = i.uv_texcoord * _TextureSample4_ST.xy + _TextureSample4_ST.zw;
			float temp_output_192_0 = ( tex2D( _TextureSample4, uv_TextureSample4 ).g * 0.1 );
			float4 lerpResult5 = lerp( _Crystal_color , _Color , smoothstepResult43);
			o.Albedo = ( temp_output_192_0 + lerpResult5 ).rgb;
			...
			float lerpResult189 = lerp( lerpResult173 , 0.0 , temp_output_192_0);
			o.Metallic = lerpResult189;
			float lerpResult64 = lerp( 0.8 , 0.5 , smoothstepResult43);
			float lerpResult172 = lerp( lerpResult64 , 0.0 , temp_output_175_0.r);
			float lerpResult188 = lerp( lerpResult172 , 0.0 , temp_output_192_0);
			o.Smoothness = lerpResult188;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;1194.937;-267.7947;1.05953;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;95;-528.7885,733.4227;Float;False;1164.812;555.8927;Normall;8;115;67;60;68;61;122;180;179;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;117.1577,823.141;Float;False;Constant;_Float22;Float 22;10;0;1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.DynamicAppendNode;122;289.6852,975.2933;Float;False;FLOAT3;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT3
...
Node;AmplifyShaderEditor.RangedFloatNode;193;862.3952,-314.6239;Float;False;Constant;_Float36;Float 36;10;0;0.1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.RelayNode;186;890.226,-209.041;Float;False;1;0;COLOR;0.0;False;1;COLOR
Node;AmplifyShaderEditor.RangedFloatNode;190;783.9659,17.26668;Float;False;Constant;_Float35;Float 35;10;0;0;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;192;1059.796,-466.8102;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleAddOpNode;185;1089.113,-371.8384;Float;False;2;2;0;FLOAT;0.0,0,0,0;False;1;COLOR;0.0;False;1;COLOR
Node;AmplifyShaderEditor.LerpOp;189;939.6766,165.9635;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.LerpOp;177;978.5125,731.4321;Float;False;3;0;FLOAT3;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.LerpOp;188;946.6902,28.48905;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT
...
WireConnection;178;0;123;0
WireConnection;192;0;184;2
...
WireConnection;189;2;192;0
WireConnection;1;3;2;0
WireConnection;1;4;3;0
WireConnection;177;0;123;0
...
ASEEND*/
//CHKSM=4108532AFC87E27036D7BA4B8089A267B3668601