...
Shader "Bobo/PBR"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult40 = lerp( lerpResult17 , ( tex2DNode1 * 1.4 ) , clampResult39);
			float4 lerpResult28 = lerp( tex2DNode1 , lerpResult40 , _Highlight_value);
			o.Albedo = lerp(tex2DNode1,lerpResult28,_Highlight_platform).rgb;
...
/*ASEBEGIN
Version=13201
1927;29;1906;1004;2831.469;1232.625;1.608445;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-560.8176,-779.6262;Float;False;Constant;_Float6;Float 6;5;0;1.4;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;29;27.38177,-412.0262;Float;False;Property;_Highlight_value;Highlight_value;5;0;0;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.LerpOp;28;187.2818,-587.5262;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0.0;False;2;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.ToggleSwitchNode;27;344.582,-470.5259;Float;False;Property;_Highlight_platform;Highlight_platform;5;0;1;2;0;COLOR;0.0;False;1;COLOR;0,0,0,0;False;1;COLOR
...
ASEEND*/
//CHKSM=14A9AEA120407866A5F19EFCE14054C32D7C7EB2