...
Shader "Bobo/CloudParticle"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 panner18 = ( ( i.texcoord_0 * 0.1 ) + 1.0 * _Time.y * float2( -0.02,0 ));
...
/*ASEBEGIN
Version=13201
-1831;105;1906;1004;991.497;306.8856;1.046051;True;True
...
Node;AmplifyShaderEditor.Vector2Node;20;-1837.313,-250.2432;Float;False;Constant;_Vector0;Vector 0;3;0;-0.02,0;0;3;FLOAT2;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=456E98C02BBFBDDC5CFB53B9C34ABEAA25ADE130