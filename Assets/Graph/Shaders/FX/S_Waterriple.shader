...
Shader "Bobo/Particle/Waterripple"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			clip( ( tex2D( _Texture0, panner2 ).r * tex2D( _Texture0, i.texcoord_1 ).g ) - _Cutoff );
		}
...
/*ASEBEGIN
Version=13201
7;29;1906;1004;1977.996;628.528;1.350505;True;True
...
Node;AmplifyShaderEditor.Vector2Node;21;-1313.548,168.2703;Float;False;Property;_Ripple_Tiling;Ripple_Tiling;6;0;0,0;0;3;FLOAT2;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;19;-235.8447,-222.0255;Float;False;Property;_Color0;Color 0;5;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=76403015B44730A42AF849431E6027196E308660