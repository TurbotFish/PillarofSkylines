...
Shader "Antoine/Rocks"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult9 = lerp( lerpResult91 , triplanar152 , temp_output_8_0);
			o.Albedo = lerpResult9.xyz;
			o.Smoothness = 0.0;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13201
-1917;27;1906;1001;1732.729;46.97742;1.326012;True;True
...
Node;AmplifyShaderEditor.ToggleSwitchNode;47;-2307.621,903.0233;Float;False;Property;_Switch_surface;Switch_surface;17;0;0;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
ASEEND*/
//CHKSM=8F768430F2F4D0E571E0DCDA6113C7D5BB762467