#ifndef ALO_PBS_LIGHTING_INCLUDED
#define ALO_PBS_LIGHTING_INCLUDED
...
inline half4 LightingStandard (SurfaceOutputStandard s, half3 viewDir, UnityGI gi)
{
    ...
    half4 c = ALO_BRDF_PBS (s.Albedo, specColor, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir, gi.light, gi.indirect,0);
    c.a = outputAlpha;
    return c;
}
...
inline half4 LightingStandardSpecular (SurfaceOutputStandardSpecular s, half3 viewDir, UnityGI gi)
{
    ...
    half4 c = ALO_BRDF_PBS (s.Albedo, s.Specular, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir, gi.light, gi.indirect,0);
    c.a = outputAlpha;
    return c;
}
