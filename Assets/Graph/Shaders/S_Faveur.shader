...
Shader "Bobo/Tomb"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult29 = lerp( 1.0 , ( triplanar24.x * (2.0 + (_Emissive_intensity - 0.0) * (0.0 - 2.0) / (10.0 - 0.0)) ) , clampResult31);
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;2053.94;1344.105;1.693494;True;False
...
ASEEND*/
//CHKSM=77A7965F7BE1DC9C4FF800647892DD3D31122A20