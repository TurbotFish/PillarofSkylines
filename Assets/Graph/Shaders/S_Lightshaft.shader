...
Shader "Bobo/Lightshaft"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Alpha = ( ( ( ( ( 1.0 - clampResult6 ) * ( ( i.texcoord_0.y * 3.0 ) * ( 1.0 - ( pow( ( i.texcoord_0.y - _FadeStart_Offset ) , 7.0 ) * 5.0 ) ) ) ) * clampResult32 ) * _Opacity ) * lerp(1.0,(0.3 + (sin( _Time.y ) - -1.0) * (1.0 - 0.3) / (1.0 - -1.0)),_SinFade) );
		}
...
/*ASEBEGIN
Version=13201
-1913;29;1906;1004;1000.808;388.3095;1.572743;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-1148.559,303.9121;Float;False;Property;_FadeStart_Offset;FadeStart_Offset;7;0;0;-1;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;43;234.0948,367.0039;Float;False;Property;_Opacity;Opacity;5;0;0;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.ToggleSwitchNode;72;722.918,481.4174;Float;False;Property;_SinFade;SinFade;8;0;0;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
ASEEND*/
//CHKSM=272CF40A46205D63FA30ABF78E1A93EA8D78532F