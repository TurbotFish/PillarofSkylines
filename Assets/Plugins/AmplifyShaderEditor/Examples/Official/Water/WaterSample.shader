...
Shader "ASESampleShaders/WaterSample"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			ase_screenPos164.xy = TransformStereoScreenSpaceTex(ase_screenPos164.xy, ase_screenPos164.w);
			#endif
			ase_screenPos164.xyzw /= ase_screenPos164.w;
			float2 componentMask165 = ase_screenPos164.xy;
			float4 screenColor65 = tex2D( _GrabTexture, ( half3( componentMask165 ,  0.0 ) + ( temp_output_24_0 * _Distortion ) ).xy );
...
/*ASEBEGIN
Version=13108
0;92;721;926;-534.877;1801.772;1.503544;True;False
...
Node;AmplifyShaderEditor.SamplerNode;105;-304.4021,674.9185;Float;True;Property;_Foam;Foam;9;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=7BC212AD0E24A139CB22083AC8FC39DCFE369742