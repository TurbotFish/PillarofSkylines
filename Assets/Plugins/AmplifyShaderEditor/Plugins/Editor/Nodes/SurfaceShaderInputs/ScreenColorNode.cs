	...
	public sealed class ScreenColorNode : PropertyNode
	{
		...
		public string GetUVCoords( ref MasterNodeDataCollector dataCollector, bool ignoreLocalVar, bool isProjecting )
		{
			...
			else
			{
				...
				dataCollector.AddLocalVariable( UniqueId,  HackInstruction[ 8 ], true );
				dataCollector.AddLocalVariable( UniqueId, string.Format( HackInstruction[ 9 ], localVarName ), true );
				dataCollector.AddLocalVariable( UniqueId, HackInstruction[ 10 ], true );
				dataCollector.AddLocalVariable( UniqueId, string.Format( HackInstruction[11], localVarName ), true );
