    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_35 = (i.uv0*2.0);
                float4 node_574 = tex2D(_AORGBHeightA,TRANSFORM_TEX(node_35, _AORGBHeightA));
                float2 node_110 = (0.15*(node_574.r - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
...
////// Specular:
                ...
                float3 diffuseColor = float3(node_42,node_42,node_42); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_42 = 0.7;
                float3 diffColor = float3(node_42,node_42,node_42);
                float specularMonochrome;
                float3 specColor;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, 0.0, specColor, specularMonochrome );
                float roughness = 1.0 - node_42;
